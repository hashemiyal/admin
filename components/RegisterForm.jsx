    ...
    const handleSubmit = async(e) => {
        ...
        if(!formData.username || !formData.email || !formData.password){
          ...
          return;
             ...
             let response= await fetch(`${process.env.NEXT_PUBLIC_API_URL}/user/register`);
         ...
         let res= await fetch(`${process.env.NEXT_PUBLIC_API_URL}/user/register`,{method:"POST",headers:{"Content-Type": "application/json",},body:JSON.stringify(formData)});
         if(res.ok){
            swal("کاربر ثبت شد !");
