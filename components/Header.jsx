  ...
  return (
    <header className="header">
      <div className="header-wrapper">
       ...
       { session?.user?.isAdmin &&  <Link href={"http://10.1.100.113/dashboard"} className="nav-link">دشبورد <RiDashboardHorizontalFill style={{display:"inline",fontSize:"30px"}} /></Link>}
        ...
        <TbMenuDeep style={{fontSize:"40px"}}/>
        </button>
      </div>
    </header>
  );
